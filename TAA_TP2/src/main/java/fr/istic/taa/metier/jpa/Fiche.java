...
public class Fiche implements Serializable {
    ...
    public Fiche(Long id, String libelle, Date dateButoire, User user, String temps, String tags, String lieu, String url, String noteExplicative) {
        this.id = id;
    ...
    public Fiche(String libelle, Date dateButoire, String temps, String tags, String lieu, String url, String noteExplicative) {
        this.libelle = libelle;
        this.dateButoire = dateButoire;
        this.temps = temps;
        this.tags = tags;
